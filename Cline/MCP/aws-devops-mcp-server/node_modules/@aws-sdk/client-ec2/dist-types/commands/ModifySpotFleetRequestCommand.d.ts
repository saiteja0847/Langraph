...
import { ModifySpotFleetRequestRequest, ModifySpotFleetRequestResponse } from "../models/models_7";
/**
 * @public
 */
...
declare const ModifySpotFleetRequestCommand_base: {
    new (input: ModifySpotFleetRequestCommandInput): import("@smithy/smithy-client").CommandImpl<ModifySpotFleetRequestCommandInput, ModifySpotFleetRequestCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifySpotFleetRequestCommandInput): import("@smithy/smithy-client").CommandImpl<ModifySpotFleetRequestCommandInput, ModifySpotFleetRequestCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
