...
import { CreateLocalGatewayVirtualInterfaceRequest, CreateLocalGatewayVirtualInterfaceResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateLocalGatewayVirtualInterfaceCommand_base: {
    new (input: CreateLocalGatewayVirtualInterfaceCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLocalGatewayVirtualInterfaceCommandInput, CreateLocalGatewayVirtualInterfaceCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateLocalGatewayVirtualInterfaceCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLocalGatewayVirtualInterfaceCommandInput, CreateLocalGatewayVirtualInterfaceCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
