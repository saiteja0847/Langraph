...
import { GetVpnConnectionDeviceSampleConfigurationRequest, GetVpnConnectionDeviceSampleConfigurationResult } from "../models/models_7";
/**
 * @public
 */
...
declare const GetVpnConnectionDeviceSampleConfigurationCommand_base: {
    new (input: GetVpnConnectionDeviceSampleConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetVpnConnectionDeviceSampleConfigurationCommandInput, GetVpnConnectionDeviceSampleConfigurationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetVpnConnectionDeviceSampleConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetVpnConnectionDeviceSampleConfigurationCommandInput, GetVpnConnectionDeviceSampleConfigurationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
