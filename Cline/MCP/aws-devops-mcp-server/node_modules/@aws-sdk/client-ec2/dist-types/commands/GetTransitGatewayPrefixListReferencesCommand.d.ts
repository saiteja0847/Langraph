...
import { GetTransitGatewayPrefixListReferencesRequest, GetTransitGatewayPrefixListReferencesResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetTransitGatewayPrefixListReferencesCommand_base: {
    new (input: GetTransitGatewayPrefixListReferencesCommandInput): import("@smithy/smithy-client").CommandImpl<GetTransitGatewayPrefixListReferencesCommandInput, GetTransitGatewayPrefixListReferencesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetTransitGatewayPrefixListReferencesCommandInput): import("@smithy/smithy-client").CommandImpl<GetTransitGatewayPrefixListReferencesCommandInput, GetTransitGatewayPrefixListReferencesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
