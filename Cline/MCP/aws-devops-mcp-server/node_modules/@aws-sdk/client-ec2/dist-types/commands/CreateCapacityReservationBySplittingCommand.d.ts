...
import { CreateCapacityReservationBySplittingRequest, CreateCapacityReservationBySplittingResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateCapacityReservationBySplittingCommand_base: {
    new (input: CreateCapacityReservationBySplittingCommandInput): import("@smithy/smithy-client").CommandImpl<CreateCapacityReservationBySplittingCommandInput, CreateCapacityReservationBySplittingCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateCapacityReservationBySplittingCommandInput): import("@smithy/smithy-client").CommandImpl<CreateCapacityReservationBySplittingCommandInput, CreateCapacityReservationBySplittingCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
