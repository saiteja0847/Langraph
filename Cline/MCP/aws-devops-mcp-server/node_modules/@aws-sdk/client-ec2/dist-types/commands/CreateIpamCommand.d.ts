...
declare const CreateIpamCommand_base: {
    new (input: CreateIpamCommandInput): import("@smithy/smithy-client").CommandImpl<CreateIpamCommandInput, CreateIpamCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [CreateIpamCommandInput]): import("@smithy/smithy-client").CommandImpl<CreateIpamCommandInput, CreateIpamCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
