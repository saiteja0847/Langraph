...
declare const CreateVpcCommand_base: {
    new (input: CreateVpcCommandInput): import("@smithy/smithy-client").CommandImpl<CreateVpcCommandInput, CreateVpcCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [CreateVpcCommandInput]): import("@smithy/smithy-client").CommandImpl<CreateVpcCommandInput, CreateVpcCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
