...
import { CreateLocalGatewayVirtualInterfaceGroupRequest, CreateLocalGatewayVirtualInterfaceGroupResult } from "../models/models_2";
/**
 * @public
 */
...
declare const CreateLocalGatewayVirtualInterfaceGroupCommand_base: {
    new (input: CreateLocalGatewayVirtualInterfaceGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLocalGatewayVirtualInterfaceGroupCommandInput, CreateLocalGatewayVirtualInterfaceGroupCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateLocalGatewayVirtualInterfaceGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLocalGatewayVirtualInterfaceGroupCommandInput, CreateLocalGatewayVirtualInterfaceGroupCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
