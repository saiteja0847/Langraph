...
import { createEc2InstanceHandler, CreateEc2InstanceArgs } from './ec2ToolHandler.js'; // Import shared handler
...
function isValidCreateEc2InstanceArgs(args: any): args is CreateEc2InstanceArgs {
  return (
    typeof args === 'object' &&
    args !== null &&
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      ...
      if (!isValidCreateEc2InstanceArgs(request.params.arguments)) {
        throw new McpError(
          ...
          'Invalid arguments for create_ec2_instance'
        );
      }

      const args: CreateEc2InstanceArgs = request.params.arguments as CreateEc2InstanceArgs;
